...
import com.chenh.smartclassroom.view.course.CourseOrPlanActivity;
import com.chenh.smartclassroom.view.course.GetMoreCourseFragment;
import com.chenh.smartclassroom.view.course.MakePlanFragment;
...
public class ClassroomDetailActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public static PlaceholderFragment newInstance(int sectionNumber) {
           PlaceholderFragment fragment=null;
            switch (sectionNumber){
                case 1:
                    fragment = new ClassroomInfoFragment();
                    break;
                case 2:
                    fragment = new ClassroomGuestbook();
                    break;
            }
            return fragment;
        }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_classroom_detail, container, false);
